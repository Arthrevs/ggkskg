...
export default function Dashboard({ nodes, selectedCorridor, onNavigate }: DashboardProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className="p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-linear-to-r from-railway-600/5 to-railway-400/5 dark:from-railway-600/10 dark:to-railway-400/10">
        <div>
