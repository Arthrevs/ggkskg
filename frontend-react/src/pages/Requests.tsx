...
import { useRequests, useCreateRequest, useUpdateRequest, useDeleteRequest, useSections } from '../api/hooks';
...
export default function Requests() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingRequest) {
        await updateRequest.mutateAsync({ id: editingRequest.id, ...form });
